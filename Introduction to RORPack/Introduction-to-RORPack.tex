...
Note that the use of this controller requires the Python Control Systems Library, which in turn requires the Python slycot library. Installation of the slycot library can be cumbersome especially on the Microsoft Windows operating system. A conda environment is recommended for this with further instructions on installing the package provided on the slycot project web page.
