...
\begin{itemize}
  ...
  \item The ``observer-based robust controller'', based on references~\citel{HamPoh10}{Sec. 7},~\citel{Pau16a}{Sec. VI},~\citel{Pau17b}{Sec. 5}. The closed-loop stability is achieved using an observer for the state of the system~\eqref{eq:plantintro}.\\[1ex]
	 ...
	 \phantom{a}\hspace{2.7cm} IMstabmargin,IMstabmethod)}
     \end{quotation}
     \medskip
...
Note that the use of this controller requires the Python Control Systems Library, which in turn requires the Python slycot library. Installation of the slycot library can be cumbersome especially on the Microsoft Windows operating system. A conda environment is recommended for this with further instructions on installing the package provided on the slycot project web page \href{https://pypi.org/project/slycot/}{https://pypi.org/project/slycot/}.
...
\begin{itemize}
  ...
  \item \href{https://github.com/python-control/python-control}{https://github.com/python-control/python-control} --- The Python Control Systems Library
\end{itemize}
